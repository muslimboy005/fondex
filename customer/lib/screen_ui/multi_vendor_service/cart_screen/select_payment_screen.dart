...
/// Savat ekrani bilan **bir xil** [CartController] dan foydalanishi shart —
/// aks holda to‘lov tanlovi boshqa instance da qoladi va "Buyurtma berish" Payme ni ishga tushirmaydi.
class SelectPaymentScreen extends StatelessWidget {
  const SelectPaymentScreen({super.key, required this.controller});

...
class YandexGeocodingService {
  ...
  /// Reverse geocoding: (latitude, longitude) -> address (o'zbekcha lotin).
  ...
  /// Reverse geocoding: returns formatted address string (lotin o'zbekcha).
  ...
  Future<LatLng?> getCoordinatesFromAddress(String address) async {
    ...
    final r = list.first;
    return LatLng(r.latLng.latitude, r.latLng.longitude);
  }

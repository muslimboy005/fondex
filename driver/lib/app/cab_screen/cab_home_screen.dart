...
class CabHomeScreen extends StatelessWidget {
        ...
        return Scaffold(
          body: controller.isLoading.value
              ...
              : Constant.isDriverVerification == true &&
                      (dashController.userModel.value.isDocumentVerify == false)
                  ? Obx(() {
                      final isDark = themeController.isDark.value;
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RoundedButtonFill(
                              ...
                              onPress: () async {
                                CabDashBoardController dashBoardController =
                  ...
                  : Column(
                      children: [
                        Obx(() {
                          ...
                          final num ownerWallet =
                              controllerOwner.walletAmount ?? 0.0;
                        ...
                        Obx(
                          () {
                            ...
                            // Bottom sheet ochilishi kerak bo'lgan statuslar:
                            // - "Driver Pending" (Constant.driverPending)
                            // - "pending_driver_acceptance" (backend dan kelgan status)
                            final shouldShow = orderId != null &&
                                (status == Constant.driverPending ||
                                    status == "pending_driver_acceptance");

                            if (shouldShow) {
                              print(
                                  "Bottom sheet ochildi - Obx: showDriverBottomSheet (status: $status)");
                            } else {
                              print(
                                  "Bottom sheet ochilmadi - Obx: showDriverBottomSheet (orderId: $orderId, status: $status)");
                            }
                            return shouldShow
                        ...
                        Obx(
                          () {
                            final shouldShow = controller.shouldShowOrderSheet;
                            if (shouldShow) {
                              print(
                                  "Bottom sheet ochildi - Obx: buildOrderActionsCard (shouldShowOrderSheet)");
                            }
                            return shouldShow
                    ...
                    child: RoundedButtonFill(
                      ...
                      onPress: () {
                        if (controller.driverModel.value.ownerId != null &&
                          ...
                          if (controller.ownerModel.value.walletAmount !=
                                  null &&
                              ...
                              InkWell(
                                onTap: () {
                                  Constant.makePhoneCall(controller
                                      .currentOrder.value.author!.phoneNumber
                                      .toString());
                                },
                                child: Container(
                                  width: 38,
    ...
    Get.dialog(
      Dialog(
        backgroundColor: isDark
            ...
            : AppThemeData.grey50,
        insetPadding:
            const EdgeInsets.symmetric(horizontal: 20), // keeps margin around
  ...
  void showConfirmCashPaymentDialog(BuildContext context, bool isDark,
            ...
            children: [
              ...
              Text(
                ...
                style: AppThemeData.mediumTextStyle(
                  fontSize: 14,
                  color:
                      isDark ? AppThemeData.greyDark900 : AppThemeData.grey700,
                ),
                textAlign: TextAlign.center,
              ),

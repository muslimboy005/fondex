            ...
            appBar: AppBar(
              ...
              title: Column(
                ...
                children: [
                  ...
                  Text(
                    (Constant.userModel?.fullName() ?? 'Driver').tr,
                    style: TextStyle(
                      color:
                          isDark ? AppThemeData.grey50 : AppThemeData.grey900,
                      fontSize: 14,
...
class DrawerView extends StatelessWidget {
                          ...
                          children: [
                            ...
                            _buildMenuCard(
                              ...
                              children: [
                                ...
                                if (controller.userModel.value.vendorID ==
                                        null ||
                                    controller
  ...
  Widget _buildProfileHeader(
      BuildContext context, DashBoardController controller, bool isDark) {
    return Container(
  ...
  Widget _buildStatusCard(DashBoardController controller, bool isDark) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isActive ? 'Online - Ready for orders'.tr : 'Offline'.tr,
                  style: TextStyle(
                    color: isActive
                        ? const Color(0xFF00C853)
                        : (isDark

                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RoundedButtonFill(
                          ...
                          onPress: () async {
                            RentalDashboardController dashBoardController =
                                Get.put(RentalDashboardController());
                    ...
                    child: Column(
                      children: [
                        Obx(() {
                          ...
                          final num minDeposit = double.parse(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              SvgPicture.asset(
                                "assets/images/empty_parcel.svg",
                              ),
                              SizedBox(height: 20),
                              Text(
                                ...
                                return InkWell(
                                  onTap: () {
                                    Get.to(
                                      ...
                                      arguments: {
                                        "rentalOrder": rentalBookingData.id,
                                      },
                                    );
                                  },
                                  child: Padding(
                                          ...
                                          rentalBookingData.status ==
                                              ...
                                              : rentalBookingData.status ==
                                                    ...
                                                    double.parse(
                                                        ...
                                                        double.parse(
                                                          rentalBookingData
                                                              .startKitoMetersReading
                                                              .toString(),
                                                        )
                                              ? RoundedButtonFill(
                                                  title:
                                                      "Set Final kilometers".tr,
                                                  height: 5.5,
                                                  color: isDark
                                                      ? AppThemeData.primary300
                                                      : AppThemeData.primary300,
            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButtonFill(
                  ...
                  onPress: () async {
                    if (controller
                            .currentKilometerController
                            .value
                            .text
                            .isEmpty ||
                        double.parse(
                              controller.currentKilometerController.value.text,
                            ) <
                            10) {
                      ShowToastDialog.showToast(
                    ...
                    rentalBookingData.startKitoMetersReading = controller
                        .currentKilometerController
                        .value
                        .text
                        .trim();
                    ...
                    await FireStoreUtils.rentalOrderPlace(
                      rentalBookingData,
                    ).then((value) {
                      ShowToastDialog.closeLoader();
                  ...
                  onPress: () async {
                    if (controller
                      ...
                      return;
                          ...
                          controller.completeKilometerController.value.text
                              .toString()
                              .trim(),
                        ) <
                        double.parse(
                          rentalBookingData.startKitoMetersReading.toString(),
                        )) {
                      ShowToastDialog.showToast(

...
import 'package:vendor/payment/MercadoPagoScreen.dart';
import 'package:vendor/payment/PayFastScreen.dart';
import 'package:vendor/payment/midtrans_screen.dart';
import 'package:vendor/payment/orangePayScreen.dart';
...
class SubscriptionController extends GetxController {
  ...
  Future<void> getInitPlanSettings() async {
    await FirebaseFirestore.instance.collection(CollectionName.settings).doc('vendor').get().then((value) {

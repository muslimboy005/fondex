...
class PhoneRegistrationController extends GetxController {
  ...
  final Rx<TextEditingController> countryCodeController = TextEditingController(
    text: "+998",
  ).obs;
  ...
  Future<void> registerWithPhone() async {
    ...
    try {
      ...
      // Bypass SSL certificate validation (only for development)
      // WARNING: Remove this in production and use proper SSL certificates
      httpClient.badCertificateCallback = (X509Certificate cert, String host, int port) {
        log("⚠️ SSL Certificate validation bypassed for: $host:$port");

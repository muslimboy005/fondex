  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FirestorePagination(
        ...
        query: FirebaseFirestore.instance.collection(CollectionName.chatAdmin).where("restaurantId", isEqualTo: FireStoreUtils.getCurrentUid()).orderBy('createdAt', descending: true),
